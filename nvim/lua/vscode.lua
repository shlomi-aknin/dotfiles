...
map('n', '<space>j', '<cmd>call VSCodeNotify("editor.action.insertLineAfter")<cr>')
map('n', '<space>k', '<cmd>call VSCodeNotify("editor.action.insertLineBefore")<cr>')
...
map('n', '<space>qq', '<cmd>call VSCodeNotify("workbench.action.revertAndCloseActiveEditor")<cr>')
map('n', '<space>tt', '<cmd>call VSCodeNotify("workbench.actions.view.toggleProblems")<cr>')
map('n', '<S-h>', '^')
map('n', '<S-l>', 'g_')
...
map('n', 'gv', 'V$%')
vim.keymap.set('', "<space><space>", function() require('hop').hint_words() end, { remap = true })
map('n', 'ss', 'Vp')
map('n', 'siw', 'viwp')
map('n', 'saw', 'vawp')
map('n', 'si(', 'vi(p')
