...
map('n', 		'<leader>djf',			':lua require("jester").debug_file()<cr>' )
map('n', 		'<leader>dn',				':lua require("dap").continue()<cr>' )
map('n', 		'<leader>dsc',			':lua local widgets=require("dap.ui.widgets");widgets.centered_float(widgets.scopes)<cr>' )
map('n', 		'<leader>dsi',			':lua require("dap").step_into()<cr>' )
map('n',		'<leader>dsr',			':lua require("dap").step_over()<cr>' )
map('n', 		'<leader>dst',			':lua require("dap").step_out()<cr>' )
