...
map('n',    '<leader>f',        ':Telescope find_files find_command=rg,--ignore,--hidden,--files,-u,--glob,!**/.git/*,--glob,!**/node_modules/*,--glob,!package-lock.json<cr>')
...
map('v',    '/',                '<cmd>lua require("spectre").open_visual({select_word=true})<cr>')
