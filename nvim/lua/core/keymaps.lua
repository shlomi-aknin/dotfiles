...
-- keymap.set({ "n", "x" }, '<leader>ca', function() require("tiny-code-action").code_action() end, { noremap = true, silent = true })
...
keymap.set('n', '<leader>wf', '<cmd>FzfxFiles cword<CR>', { noremap = true, silent = true })
...
keymap.set('v', 'FF', ":GrugFar<CR>", { noremap = true, silent = true })
