...
map('n', '<C-a>', ':CtrlSFToggle<cr>', { silent = true })
map('n', '<C-c>', ':bd<cr>')
...
map('n', '<C-p>', 'viwp')
-- map('n', '<C-s>', '<plug>(esearch)', { silent = true })
map('n', '<C-s>', '<plug>CtrlSFPrompt', { silent = false })
map('n', '<C-t>', ':enew<cr>')
map('n', '<C-x>', ':bd!<cr>')
map('n', '<Tab>j', 'yyp')
map('n', '<Tab>k', 'yyP')
...
map('n', '<leader>l', ':e<cr>')
map('n', '<leader>m', ':Telescope lsp_document_symbols<cr>')
map('n', '<leader>p', ':Telescope aerial<cr>')
