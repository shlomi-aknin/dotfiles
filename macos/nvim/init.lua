...
key('n', 'J', 'yyp', { silent=true })
key('n', 'K', 'yyP', { silent=true })
key('n', 'H', ':bp<cr>', { silent=true })
key('n', 'L', ':bn<cr>', { silent=true })
key('n', 'T', ':enew<cr>', { silent=true })
...
key('n', '<space>x', ':bufdo bd<cr>', { silent=true })
